...
stage : rel
	$(foreach dep,$(wildcard deps/* wildcard apps/*), rm -rf rel/kvstore/lib/$(shell basename $(dep))-* && ln -sf $(abspath $(dep)) rel/kvstore/lib;)
...
COMBO_PLT = $(HOME)/.kvstore_combo_dialyzer_plt
